...
POWER_BI_PUSH_URL = 'https://api.powerbi.com/beta/68519e48-83f3-435f-a38a-1a7aa77ba987/datasets/4f9b5af3-f387-4683-bc54-097c738ea168/rows?experience=power-bi&key=lEnbCsiXb6G%2B%2BWxDi6W1yeCHMSS%2FWbGX1yNKw7YAaG1IxYwCsGIvwOPyEerTppp87VTX0wQ5wQUR3I8P3wX58A%3D%3D'
        ...
        while self.consumer is None:
            try:
                self.consumer = KafkaConsumer(
                    ...
                    session_timeout_ms=30000,  # Aumentar el timeout de la sesión
                    heartbeat_interval_ms=10000,  # Aumentar el intervalo de heartbeat
